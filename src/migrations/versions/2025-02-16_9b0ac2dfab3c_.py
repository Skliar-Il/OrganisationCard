...
Revision ID: 9b0ac2dfab3c
Revises: 
Create Date: 2025-02-16 19:41:24.065893
...
def upgrade() -> None:
    ...
    op.create_table('activity',
                    ...
                    sa.CheckConstraint('depth >= 0 AND depth <= 2', name='check_depth_range'),
...
def downgrade() -> None:
    ...
    op.create_table('pagc_rules',
                    ...
                    sa.Column('is_custom', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False,
                              nullable=True),
    ...
    op.create_table('tabblock',
                    ...
                    sa.Column('the_geom', geoalchemy2.types.Geometry(spatial_index=False, from_text='ST_GeomFromEWKT',
                                                                     name='geometry', _spatial_index_reflected=True),
                              autoincrement=False, nullable=True),
                    sa.CheckConstraint("geometrytype(the_geom) = 'MULTIPOLYGON'::text OR the_geom IS NULL",
    ...
    op.create_table('state',
                    ...
                    sa.Column('intptlat', sa.VARCHAR(length=11), autoincrement=False, nullable=True),
                    sa.Column('intptlon', sa.VARCHAR(length=12), autoincrement=False, nullable=True),
                    sa.Column('the_geom', geoalchemy2.types.Geometry(from_text='ST_GeomFromEWKT', name='geometry',
    ...
    op.create_table('street_type_lookup',
                    ...
                    sa.Column('is_hw', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=False),
    ...
    op.create_table('tabblock20',
                    ...
                    sa.Column('intptlon', sa.VARCHAR(length=12), autoincrement=False, nullable=True),
                    sa.Column('the_geom',
                              geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=4269, spatial_index=False,
                                                         from_text='ST_GeomFromEWKT', name='geometry',
                                                         _spatial_index_reflected=True), autoincrement=False,
                              nullable=True),
    ...
    op.create_table('topology',
                    ...
                    sa.Column('hasz', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=False),
    ...
    op.create_table('loader_lookuptables',
                    sa.Column('process_order', sa.INTEGER(), server_default=sa.text('1000'), autoincrement=False,
                              nullable=False),
                    ...
                    sa.Column('single_mode', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False,
                              nullable=False),
                    ...
                    sa.Column('level_county', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=False),
                    sa.Column('level_state', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=False),
                    sa.Column('level_nation', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=False,
                    ...
                    sa.Column('single_geom_mode', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=True),
                    sa.Column('insert_mode', sa.CHAR(length=1), server_default=sa.text("'c'::bpchar"),
    ...
    op.create_table('edges',
                    ...
                    sa.Column('the_geom', geoalchemy2.types.Geometry(from_text='ST_GeomFromEWKT', name='geometry',
                                                                     _spatial_index_reflected=True),
                              autoincrement=False, nullable=True),
                    sa.CheckConstraint("geometrytype(the_geom) = 'MULTILINESTRING'::text OR the_geom IS NULL",
                                       name='enforce_geotype_the_geom'),
                    sa.CheckConstraint('st_ndims(the_geom) = 2', name='enforce_dims_the_geom'),
                    sa.CheckConstraint('st_srid(the_geom) = 4269', name='enforce_srid_the_geom'),
    ...
    op.create_table('addrfeat',
                    ...
                    sa.Column('the_geom', geoalchemy2.types.Geometry(from_text='ST_GeomFromEWKT', name='geometry',
                                                                     _spatial_index_reflected=True),
                              autoincrement=False, nullable=True),
                    sa.CheckConstraint("geometrytype(the_geom) = 'LINESTRING'::text OR the_geom IS NULL",
                                       name='enforce_geotype_the_geom'),
                    sa.CheckConstraint('st_ndims(the_geom) = 2', name='enforce_dims_the_geom'),
                    sa.CheckConstraint('st_srid(the_geom) = 4269', name='enforce_srid_the_geom'),
    ...
    op.drop_index('idx_building_geom', table_name='building', postgresql_using='gist')
